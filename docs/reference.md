...
This is the expanded reference behind the shorter top-level README.
...
Curated generated snapshots for that path live in [docs/demo/laravel-happy-path](demo/laravel-happy-path/README.md).
...
Curated generated snapshots for that path live in [docs/demo/express-happy-path](demo/express-happy-path/README.md).
...
Curated generated snapshots for that path live in [docs/demo/go-happy-path](demo/go-happy-path/README.md).
